...
#SBATCH --job-name generate_synthetic_data_WGS_PCAWG.96.Liver-HCC 
#SBATCH -t 0-01:00 
#SBATCH -p shared
#SBATCH --mem=16G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC/logs/output_%j_generate_synthetic_data_WGS_PCAWG.96.Liver-HCC.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC/logs/error_%j_generate_synthetic_data_WGS_PCAWG.96.Liver-HCC.err 
