...
#SBATCH -c 4
#SBATCH --job-name infer_loadings_initial_WGS_PCAWG.96.Ovary-AdenoCA_ALT 
#SBATCH -t 3-00:00 
#SBATCH -p shared
#SBATCH --mem=64G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Ovary-AdenoCA_ALT/logs/output_%j_infer_loadings_initial_WGS_PCAWG.96.Ovary-AdenoCA_ALT.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Ovary-AdenoCA_ALT/logs/error_%j_infer_loadings_initial_WGS_PCAWG.96.Ovary-AdenoCA_ALT.err 
