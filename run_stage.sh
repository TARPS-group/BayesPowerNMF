...
# for c in WGS_PCAWG.96.Ovary-AdenoCA WGS_PCAWG.96.ready.Lung-AdenoCA WGS_PCAWG.96.Stomach-AdenoCA WGS_PCAWG.96.Skin-Melanoma WGS_PCAWG.96.Breast WGS_PCAWG.96.Liver-HCC  
# do
