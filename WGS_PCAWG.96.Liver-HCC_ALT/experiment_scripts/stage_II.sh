...
#SBATCH --job-name generate_synthetic_data_WGS_PCAWG.96.Liver-HCC_ALT 
#SBATCH -t 0-01:00 
#SBATCH -p shared
#SBATCH --mem=16G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC_ALT/logs/output_%j_generate_synthetic_data_WGS_PCAWG.96.Liver-HCC_ALT.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC_ALT/logs/error_%j_generate_synthetic_data_WGS_PCAWG.96.Liver-HCC_ALT.err 
...
NEW_PREFIX=synthetic-326-liver-hcc-1-4-5-6-9-12-14-16-17a-17b-18-19-22-24-26-28-29-30-31-35-40
SIGS_FILE=""
