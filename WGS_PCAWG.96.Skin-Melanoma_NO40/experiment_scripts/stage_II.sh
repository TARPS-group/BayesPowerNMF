...
#SBATCH --job-name generate_synthetic_data_WGS_PCAWG.96.Skin-Melanoma_NO40 
#SBATCH -t 0-01:00 
#SBATCH -p shared
#SBATCH --mem=16G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Skin-Melanoma_NO40/logs/output_%j_generate_synthetic_data_WGS_PCAWG.96.Skin-Melanoma_NO40.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Skin-Melanoma_NO40/logs/error_%j_generate_synthetic_data_WGS_PCAWG.96.Skin-Melanoma_NO40.err 
...
NEW_PREFIX=synthetic-107-skin-melanoma-1-2-5-7a-7b-7c-7d-13-17a-17b-38
SIGS_FILE=""
SIGS_PREFIX="Signature"
SIGNATURES="1 2 5 7a 7b 7c 7d 13 17a 17b 38"
SAVE_DIR=WGS_PCAWG.96.Skin-Melanoma_NO40/synthetic_data
S=1
N=107
