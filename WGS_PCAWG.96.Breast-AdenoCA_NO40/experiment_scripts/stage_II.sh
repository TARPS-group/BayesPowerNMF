...
#SBATCH --job-name generate_synthetic_data_WGS_PCAWG.96.Breast-AdenoCA_NO40 
#SBATCH -t 0-01:00 
#SBATCH -p shared
#SBATCH --mem=16G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Breast-AdenoCA_NO40/logs/output_%j_generate_synthetic_data_WGS_PCAWG.96.Breast-AdenoCA_NO40.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Breast-AdenoCA_NO40/logs/error_%j_generate_synthetic_data_WGS_PCAWG.96.Breast-AdenoCA_NO40.err 
...
NEW_PREFIX=synthetic-198-breast-adenoca-1-2-3-5-8-9-13-17a-17b-18-37-41
SIGS_FILE=""
