...
#SBATCH --job-name generate_synthetic_data_sparse.WGS_PCAWG.96.Breast-AdenoCA 
#SBATCH -t 0-01:00 
#SBATCH -p shared
#SBATCH --mem=32G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Breast-AdenoCA/logs/output_%j_generate_synthetic_data_sparse.WGS_PCAWG.96.Breast-AdenoCA.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Breast-AdenoCA/logs/error_%j_generate_synthetic_data_sparse.WGS_PCAWG.96.Breast-AdenoCA.err 
...
NEW_PREFIX=synthetic-214-breast-adenoca-
SIGS_FILE=""
SIGS_PREFIX="Signature"
SIGNATURES=""
SAVE_DIR=sparse.WGS_PCAWG.96.Breast-AdenoCA/synthetic_data
S=1
N=214
