...
#SBATCH -c 4
#SBATCH --job-name infer_loadings_initial_sparse.WGS_PCAWG.96.Breast-AdenoCA 
#SBATCH -t 1-00:00 
#SBATCH -p shared
#SBATCH --mem=32G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Breast-AdenoCA/logs/output_%j_infer_loadings_initial_sparse.WGS_PCAWG.96.Breast-AdenoCA.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Breast-AdenoCA/logs/error_%j_infer_loadings_initial_sparse.WGS_PCAWG.96.Breast-AdenoCA.err 
