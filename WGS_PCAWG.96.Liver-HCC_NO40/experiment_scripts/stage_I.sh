...
#SBATCH -c 4
#SBATCH --job-name infer_loadings_initial_WGS_PCAWG.96.Liver-HCC_NO40 
#SBATCH -t 0-02:00 
#SBATCH -p shared
#SBATCH --mem=64G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC_NO40/logs/output_%j_infer_loadings_initial_WGS_PCAWG.96.Liver-HCC_NO40.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/WGS_PCAWG.96.Liver-HCC_NO40/logs/error_%j_infer_loadings_initial_WGS_PCAWG.96.Liver-HCC_NO40.err 
