...
#SBATCH -c 4
#SBATCH --job-name infer_loadings_initial_sparse.WGS_PCAWG.96.Skin-Melanoma 
#SBATCH -t 1-00:00 
#SBATCH -p shared
#SBATCH --mem=32G 
#SBATCH -o /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Skin-Melanoma/logs/output_%j_infer_loadings_initial_sparse.WGS_PCAWG.96.Skin-Melanoma.out 
#SBATCH -e /net/rcstorenfs02/ifs/rc_labs/miller_lab/csxue/bayes-power-sig/sparse.WGS_PCAWG.96.Skin-Melanoma/logs/error_%j_infer_loadings_initial_sparse.WGS_PCAWG.96.Skin-Melanoma.err 
